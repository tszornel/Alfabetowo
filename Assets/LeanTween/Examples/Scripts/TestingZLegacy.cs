...
//		alphaExample();
	...
	public void updateValue3Example(){
		GameLog.LogMessage("updateValue3Example Time:"+Time.time);
	...
	public void updateValue3ExampleUpdate( Vector3 val){
		//GameLog.LogMessage("val:"+val+" obj:"+obj);
	}

	public void updateValue3ExampleCallback( Vector3 val ){
		ltLogo.transform.eulerAngles = val;
		// GameLog.LogMessage("updateValue3ExampleCallback:"+val);
	}

	public void loopTestClamp(){
		GameLog.LogMessage("loopTestClamp Time:"+Time.time);
	...
	public void loopTestPingPong(){
		GameLog.LogMessage("loopTestPingPong Time:"+Time.time);
	...
	public void moveOnACurveExample(){
		GameLog.LogMessage("moveOnACurveExample Time:"+Time.time);
	...
	public void customTweenExample(){
		GameLog.LogMessage("customTweenExample starting pos:"+ltLogo.transform.position+" origin:"+origin);
	...
	public void moveExample(){
		GameLog.LogMessage("moveExample");
	...
	public void rotateExample(){
		GameLog.LogMessage("rotateExample");
	...
	public void rotateOnUpdate( float val ){
		//GameLog.LogMessage("rotating val:"+val);
	}

	public void rotateFinished( object hash ){
		Hashtable h = hash as Hashtable;
		GameLog.LogMessage("rotateFinished hash:"+h["yo"]);
	}
	
	public void scaleExample(){
		GameLog.LogMessage("scaleExample");
	...
	public void updateValueExample(){
		GameLog.LogMessage("updateValueExample");
	...
	public void updateValueExampleCallback( float val, object hash ){
		// Hashtable h = hash as Hashtable;
		// GameLog.LogMessage("message:"+h["message"]+" val:"+val);
	...
	public void delayedCallExample(){
		GameLog.LogMessage("delayedCallExample");
	...
	public void delayedCallExampleCallback(){
		GameLog.LogMessage("Delayed function was called");
		Vector3 currentScale = ltLogo.transform.localScale;
	...
	public void alphaExample(){
		GameLog.LogMessage("alphaExample");
	...
	public void moveLocalExample(){
		GameLog.LogMessage("moveLocalExample");
	...
	public void rotateAroundExample(){
		GameLog.LogMessage("rotateAroundExample");
