...
public class LTDescr
{
	...
	public LTDescr cancel( GameObject gameObject ){
		// GameLog.LogMessage("canceling id:"+this._id+" this.uniqueId:"+this.uniqueId+" go:"+this.trans.gameObject);
	...
	public LTDescr setRotateAround(){
		...
		this.easeInternal = ()=>{
			...
			// GameLog.LogMessage("this._optional.point:"+this._optional.point);
	...
	public LTDescr setColor(){
		...
		this.easeInternal = ()=>{
			...
			#endif
				// GameLog.LogMessage("val:"+val+" tween:"+tween+" tween.diff:"+tween.diff);
...
//		GameLog.LogMessage ("tween:" + this+ " dt:"+dt);
		if(this.delay<=0f && directionLocal!=0f){
			...
			//			GameLog.LogMessage("lt "+this+" dt:"+dt+" fin:"+isTweenFinished);
...
//		val = (val * val * val * val - 2f);
	...
	*/
	...
	public LTDescr setId( uint id, uint global_counter ){
		...
		// GameLog.LogMessage("Global counter:"+global_counter);
		return this;
	}
	...
	* @example
	* <i>C#:</i><br>
	* LeanTween.moveX(gameObject, 5f, 2.0f ).setOnStart( ()=>{ GameLog.LogMessage("I started!"); });
	* <i>Javascript:</i><br>
	* LeanTween.moveX(gameObject, 5f, 2.0f ).setOnStart( function(){ GameLog.LogMessage("I started!"); } );
	*/
	...
	*/
	...
	public LTDescr setDirection( float direction ){
		if(this.direction!=-1f && this.direction!=1f){
			GameLog.LogWarning("You have passed an incorrect direction of '"+direction+"', direction must be -1f or 1f");
			return this;
		}

		if(this.direction!=direction){
			// GameLog.LogMessage("reverse path:"+this.path+" spline:"+this._optional.spline+" hasInitiliazed:"+this.hasInitiliazed);
			if(this.hasInitiliazed){
