...
* &nbsp;GameLog.LogMessage("I have started");<br>
* });<br>
...
* &nbsp;GameLog.LogMessage("We are done now obj value:"+dict["hi"]);<br>
...
public class LTSeq {
	...
	public int id{
		get{ 
			...
			if(_id!=backId || backCounter!=counter){
				GameLog.LogMessageError("BAD CONVERSION toId:"+_id);
			}*/
	...
	private LTSeq addOn(){
		...
		// GameLog.LogMessage("this.current:" + this.current.id + " lastCurrent:" + lastCurrent.id);
...
//		GameLog.LogMessage("delay:"+delay+" count:"+this.current.count+" this.current.totalDelay:"+this.current.totalDelay);
...
//		GameLog.LogMessage("newTween:" + newTween);
	...
	* &nbsp;GameLog.LogMessage("We are done now obj value:"+dict["hi"]);
...
//		GameLog.LogMessage("tween:" + tween + " delay:" + this.current.totalDelay);
...
//		GameLog.LogMessage("this.current:" + this.current.previous.debugIter+" tween:"+this.current.previous.tween);
...
//			GameLog.LogMessage("seq.count:" + count + " seq.tween:" + seq.tween);
			seq.totalDelay *= timeScale;
			if (seq.tween != null) {
//			GameLog.LogMessage("seq.tween.time * timeScale:" + seq.tween.time * timeScale + " seq.totalDelay:"+seq.totalDelay +" time:"+seq.tween.time+" seq.tween.delay:"+seq.tween.delay);
