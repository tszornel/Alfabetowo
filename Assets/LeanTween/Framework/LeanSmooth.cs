...
* GameLog.LogMessage("Smoothed y:" + fromY + " vec3:" + fromVec3 + " color:" + fromColor);<br />
*
* @class LeanSmooth
*/
...
public class LeanSmooth {
    ...
    * GameLog.LogMessage("current:"+followVar);
    */
    ...
    * GameLog.LogMessage("current:"+transform.position);
    */
    ...
    * GameLog.LogMessage("current:"+fromColor);
    */
